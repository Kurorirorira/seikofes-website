...
export default function Plan(){
    ...
    const items3 = [
        {
            title: "中1学年ルーム 「ガンプラ展示会」",
            description: "メンバーが趣味で集めているガンプラをできるだけ沢山展示しています。またガンプラの製作体験会も実施するので是非一度足を運んでください。",
            image: "/images/3F A ガンプラ展示会.webp",
        },
        {
            title: "C1A 「Rainbow☆Candy☆Cotton」",
            description: "高校テニス部が運営するわたあめ屋です！夢と希望とわたあめをお届けします！",
            image: "/images/3F B Rainbow⭐︎Candy⭐︎Cotton.webp",
        },
        {
            title: "C1B 「Pancakes & Paws」",
        ...
        {
            title: "C2B 「コスパラ！」",
            description: "ようこそ、非日常の世界へ！男子校の高校生がアニメキャラに大変身。女装も本気！推しが給仕する夢のひとときをぜひご堪能ください。写真撮影も大歓迎！あなたのご来店、お待ちしております。",
        ...
        {
            title: "BIGIRION 「プログラミングFesta2025!!!」",
            description: "ロボットの競技や、部員が作ったゲームで遊べる体験型ブース！プログラミングの楽しさをその場で実感しよう！",
            image: "/images/3F K プログラミングfesta2025!!!.webp",
        },
        {
            title: "BIGIRION 「VR空間展示」",
        ...
        {
            title: "科学室 「目指せスピードスター☆彡」",
            description: "3つのミニゲームをクリアして速度を競うRTAゲーム",
            image: "/images/3F M 目指せスピードスター☆彡.webp",
        },
        {
            title: "自習室 「鉄道クラブ」",
            description: "本物そっくりの鉄道模型を展示中！見て楽しむのはもちろん、鉄道運転シミュレーター(BVE)で運転士気分も味わえます。鉄道グッズも展示中。気軽に遊びに来てください！",
            image: "/images/3F N 鉄道クラブ.webp",
        },
        {
            title: "クリラボ1&2 「ビーストハウス」",
            description: "暗闇に潜む”先輩”が、あなたを待っている…。教室の奥から聞こえる声の正体は、あなたの想像を超える存在かもしれない。勇気のある者だけ、ビーストハウスへー来いよ",
            image: "/images/3F O ビーストハウス.JPG",
        },
        {
            title: "クリラボ3 「不思議な美術館からの脱出」",
        ...
        {
            title: "K1B 「燕子花」",
            description: "大正ロマンと英国メイドがつくる、華やかな空間へようこそ。扉を開ければ、そこは大正時代の雰囲気と英国の優雅さがひとつになった別世界。英国メイドたちが心を込めておもてなしします。",
            image: "/images/3F S 燕子花.webp",
        },
        {
            title: "K1A 「S&G (Smoothie and Gelateria)」",
            description: "スムージーとジェラートを提供しています。スムージーはみかんや桃などの果物、ジェラートは４つの異なる温度で焙煎したお茶のそれぞれの風味をゆっくりとお楽しみいただけます。ぜひお越しください。",
            image: "/images/3F T S&G (Smoothie and Gelateria).webp",
        },
        {
            title: "K1A 「STARVALX」",
            description: "この企画は普段プロテインに縁がない人でもより身近に美味しく！楽しめる様になって欲しいと言う願いを込めた思いからできた企画です。",
    ...
    const items4 = [
        ...
        {
            title: "物理室 「ドローン操縦体験」",
            description: "DJIフライトシミュレーターで操作方法を確認してから、実際のドローンを操縦できます、そのほかにも部員が所持しているドローンが展示されており、御覧いただけます。",
            image: "/images/4F F ドローン体験会.webp",
        },
        {
            title: "生物室 「聖光写真展」",
            description: "この企画は聖光生や先生方が普段撮っている写真などを展示しています。写真の魅力がみなさんにも伝わるような物も沢山あるので是非見に来て下さい！",
        ...
        {
            title: "K2A 「シュワッと型抜き横丁」",
            description: "「夏祭りといえばこれ！」という雰囲気をぎゅっと詰め込んだ、型抜きとラムネのお店です。昔懐かしい型抜きや冷たいラムネは夏にぴったりで、挑戦の後にひと息つけば、夏祭りの楽しさをさらに感じられます。子どもから大人まで、思いでと涼しさを一緒に楽しんでください。",
